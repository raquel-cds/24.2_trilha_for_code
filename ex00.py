texto = ("Python é uma linguagem de programação de alto nível, interpretada de script,"
          ...
          " como um todo, não é formalmente especificada. O padrão na pratica é a implementação CPython. "
...
textonew = texto.replace("Python", "Fython") # trocando Python por Fython
print(textonew)